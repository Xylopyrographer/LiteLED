...
- [Driver Architecture](#driver-architecture)
  - [LiteLED — RMT Driver](#liteled--rmt-driver)
    ...
    - [Availability and Limits](#availability-and-limits)
    - [When to Choose LiteLED](#when-to-choose-liteled)
    - [Pros and Cons](#pros-and-cons)
    - [Class Interface](#class-interface)
  - [LiteLEDpio — PARLIO Single-Strip Driver](#liteledpio--parlio-single-strip-driver)
    - [How It Works](#how-it-works-1)
    - [Availability and Limits](#availability-and-limits-1)
    - [When to Choose LiteLEDpio](#when-to-choose-liteledpio)
  ...
  - [LiteLEDpioGroup / LiteLEDpioLane — PARLIO Multi-Strip Driver](#liteledpiogroup--liteledpiolane--parlio-multi-strip-driver)
    ...
    - [Availability and Limits](#availability-and-limits-2)
    - [When to Choose LiteLEDpioGroup](#when-to-choose-liteledpiogroup)
...
- [Library API](#library-api)
  ...
  - [Initialization — `begin()`](#initialization--begin)
    - [`begin()` — LiteLED (RMT)](#begin--liteled-rmt)
      - [Basic](#basic)
      - [With PSRAM control](#with-psram-control)
      - [Full configuration](#full-configuration)
    - [`begin()` — LiteLEDpio (PARLIO)](#begin--liteledpio-parlio)
      - [Basic](#basic-1)
      - [With PSRAM control](#with-psram-control-1)
    - [`begin()` — LiteLEDpioGroup (PARLIO)](#begin--liteledpiogroup-parlio)
  - [Strip Registration — `addStrip()` (LiteLEDpioGroup)](#strip-registration--addstrip-liteledpiogroup)
  ...
  - [Instance Management Methods](#instance-management-methods)
    ...
    - [`operator[](lane)` — LiteLEDpioGroup](#operatorlane--liteledpiogroup)
- [Advanced Features](#advanced-features)
  - [Multi-Display Support](#multi-display-support)
    - [Multi-Display with the RMT Driver](#multi-display-with-the-rmt-driver)
    ...
    - [Multi-Display with the PARLIO Driver](#multi-display-with-the-parlio-driver)
  - [PSRAM for Large Arrays](#psram-for-large-arrays)
    - [Instance Validation](#instance-validation)
- [Utilities](#utilities)
  - [Version Macros](#version-macros)
    - [`LITELED_VERSION_MAJOR`, `LITELED_VERSION_MINOR`, `LITELED_VERSION_PATCH`](#liteled_version_major-liteled_version_minor-liteled_version_patch)
